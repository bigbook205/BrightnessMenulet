...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    if(![[[defaults dictionaryRepresentation] allKeys] containsObject:@"LMUAutoMin"])
        [defaults setFloat:0 forKey:@"LMUAutoMin"];
    
    if(![[[defaults dictionaryRepresentation] allKeys] containsObject:@"LMUAutoMax"])
        [defaults setFloat:50 forKey:@"LMUAutoMax"];
